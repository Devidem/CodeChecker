 ...
 * программы
 */
//То есть, в случаях когда ошибка появляется из-за генерации некорректного пути благодаря кривым методам или ручкам,
//которые их используют, мы получаем MyFileIOException
