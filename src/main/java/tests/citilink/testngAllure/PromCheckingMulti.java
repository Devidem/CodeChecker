...
public class PromCheckingMulti implements Screenshootable, Retryable {
    String[][] singleCheckList;
    WebDriver driver;
    String browserName;
    String siteName;

    public PromCheckingMulti(String[][] singleCheckList, String browserName, String siteName, int queueNum) {
